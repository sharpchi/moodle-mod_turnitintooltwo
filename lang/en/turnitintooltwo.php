...
$string['no'] = 'No';
$string['yes'] = 'Yes';
$string['restorationassignmenterror1'] = 'Could not add a new course module to the course {$a}';
$string['restorationassignmenterror2'] = 'Could not add the new course module to that section - course {$a}';
$string['restorationcoursecreateerror'] = 'Course {$a} could not be created on Moodle';
$string['restorationcoursecreatederror'] = 'Course {$a} was recreated but there was an error saving the link';
$string['restorationcoursecreated'] = 'Class from Turnitin recreated on Moodle';
$string['restorationcoursegeterror'] = 'Unable to get any of the classes from Turnitin';
$string['restorationassignmentgeterror'] = 'Unable to get any of the assignments from Turnitin';
...
$string['restorationheader'] = 'Restoration Tool';
$string['restorationassignmentcreated'] = 'Restoration Assignment created - Id: {$a}';
$string['restorationassignmentpartcreated'] = 'Restoration Assignment part created - Id: {$a}';
$string['restorationassignmentcreationerror'] = 'Could not create restoration assignment - course {$a}';
...
$string['migrationtool_begin'] = 'Begin Migration';
$string['migrationtool_complete'] = 'Migration Complete';
$string['migrationtool_trial'] = 'Trial Migration';
$string['migrationtool_checklisttext'] = 'Please ensure the following has taken place:';
$string['migrationtool_checklist'] = 'Have existing courses with V1 assignments been backed up?';
